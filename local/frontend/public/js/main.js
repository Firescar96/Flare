...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.IncludeTemplate = exports.Sidebar = exports.Navbar = undefined;
	...
	var _Connections = __webpack_require__(228);
	...
	var Sidebar = _react2.default.createClass({
	  ...
	  checkPath: function checkPath(id) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { src: '/images/logo.png', alt: 'Flare logo', height: '50', width: '140' })
	      ),
	      _react2.default.createElement(
	        'ul',
	        null,
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { className: this.checkPath('/connections'), href: '/connections' },
	            _react2.default.createElement('span', { className: 'icon fa fa-globe', 'aria-hidden': 'true' }),
	            'Connections'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { className: this.checkPath('/submit'), href: '/submit' },
	            _react2.default.createElement('span', { className: 'icon fa fa-cloud-upload', 'aria-hidden': 'true' }),
	            'Submit'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { className: this.checkPath('/settings'), href: '/settings' },
	            _react2.default.createElement('span', { className: 'icon fa fa-cloud-download', 'aria-hidden': 'true' }),
	            'Settings'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { className: this.checkPath('/logs'), href: '/logs' },
	            _react2.default.createElement('span', { href: '/logs', className: 'icon fa fa-list', 'aria-hidden': 'true' }),
	            'Logs'
	          )
	        )
	      )
	...
	var Navbar = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'a',
	        { href: 'https://github.com/lumichael94/flare',
	          id: 'github', className: 'fa fa-github' },
	        'Github Repository'
	      )
	    );
	  }
	...
	var IncludeTemplate = _react2.default.createClass({
	  displayName: 'IncludeTemplate',

	  componentDidMount: function componentDidMount() {
	    var componentRoot = _react2.default.findDOMNode(this);
	...
	exports.IncludeTemplate = IncludeTemplate;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Spark = _react2.default.createClass({
	  displayName: 'Spark',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _globals.ws.addCallback('sparkNodeInfo', function (message) {
	...
	var Cassandra = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _globals.ws.addCallback('cassandraNodeInfo', function (message) {
	...
	var IPFS = _react2.default.createClass({
	  displayName: 'IPFS',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _globals.ws.addCallback('ipfsNodeInfo', function (message) {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          null,
	          'Welcome to Project: FLARE'
	        ),
	        _react2.default.createElement(Spark, null),
	        _react2.default.createElement(Cassandra, null),
	        _react2.default.createElement(IPFS, null)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ws = exports.IncludeTemplate = exports.Sidebar = exports.Navbar = undefined;
	...
	var ws = new WebSocket('ws://localhost:35273');
	ws.onmessage = function (message) {
	  message = JSON.parse(message.data);
	  console.log(message);
	  if (message.flag) {
	    wsCallbacks[message.flag].forEach(function (callback) {
	...
	ws.addCallback = function (type, callback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SparkConnect = _react2.default.createClass({
	  displayName: 'SparkConnect',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _globals.ws.addCallback('sparkConnections', function (message) {
	      _this.setState(message);
	    });
	  },
	  render: function render() {
	...
	var CassandraConnect = _react2.default.createClass({
	  displayName: 'CassandraConnect',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _globals.ws.addCallback('cassandraConnections', function (message) {
	      _this2.setState(message);
	    });
	  },
	  render: function render() {
	...
	var IPFSConnect = _react2.default.createClass({
	  displayName: 'IPFSConnect',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _globals.ws.addCallback('ipfsConnections', function (message) {
	      _this3.setState(message);
	    });
	  },
	  render: function render() {
	...
	var Connections = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { id: 'connections-page', className: 'page' },
	      _react2.default.createElement(_globals.Navbar, null),
	      _react2.default.createElement(_globals.Sidebar, { path: window.location.pathname }),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(SparkConnect, null),
	        _react2.default.createElement(CassandraConnect, null),
	        _react2.default.createElement(IPFSConnect, null)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Flare = _react2.default.createClass({
	  displayName: 'Flare',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h4',
	            null,
	            'Changing the disabled options may break Flare'
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'halfColumn' },
	...
	var Settings = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { id: 'settings-page', className: 'page' },
	      _react2.default.createElement(_globals.Navbar, null),
	      _react2.default.createElement(_globals.Sidebar, { path: window.location.pathname }),
	      _react2.default.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TRACING_LOG = 'cassandraTracingLog';
	var SESSION_LOG = 'cassandraSessionLog';

	var Logs = _react2.default.createClass({
	  displayName: 'Logs',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _globals.ws.addCallback('getLog', function (message) {
	      var update = {};
	  ...
	  changeLog: function changeLog(event) {
	    this.setState({ currentLog: event.target.value });
	    _globals.ws.send(JSON.stringify({ flag: 'getLog', type: event.target.value }));
	  },

	  render: function render() {
	    console.log("classnames: " + (0, _classnames2.default)({ hide: !(this.state.currentLog.localeCompare(SESSION_LOG) == 0) }));
	    return _react2.default.createElement(
	      'div',
	      { id: 'logs-page', className: 'page' },
	      _react2.default.createElement(_globals.Navbar, null),
	      _react2.default.createElement(_globals.Sidebar, { path: window.location.pathname }),
	      _react2.default.createElement(
	        'h1',
	      ...
	      _react2.default.createElement(
	        'div',
	        { id: 'log-select', className: 'row text-center' },
	        _react2.default.createElement(
	          'label',
	          { htmlFor: SPARK_UI_LOG },
	          _react2.default.createElement('input', { id: SPARK_UI_LOG, name: 'logtype', type: 'radio', value: SPARK_UI_LOG,
	        ...
	        _react2.default.createElement(
	          'label',
	          { htmlFor: SPARK_LOG },
	          _react2.default.createElement('input', { id: SPARK_LOG, name: 'logtype', type: 'radio', value: SPARK_LOG,
	        ...
	        _react2.default.createElement(
	          'label',
	          { htmlFor: TRACING_LOG },
	          _react2.default.createElement('input', { id: TRACING_LOG, name: 'logtype', type: 'radio', value: TRACING_LOG,
	            checked: this.state.currentLog.localeCompare(TRACING_LOG) === 0 ? 'checked' : '',
	            onChange: this.changeLog }),
	          _react2.default.createElement(
	            'span',
	            null,
	        ...
	        _react2.default.createElement(
	          'label',
	          { htmlFor: SESSION_LOG },
	          _react2.default.createElement('input', { id: SESSION_LOG, name: 'logtype', type: 'radio', value: SESSION_LOG,
	            checked: this.state.currentLog.localeCompare(SESSION_LOG) === 0 ? 'checked' : '',
	            onChange: this.changeLog }),
	          _react2.default.createElement(
	            'span',
	            null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)({ hide: !(this.state.currentLog.localeCompare(SPARK_UI_LOG) == 0) }) },
	          this.state.sparkUILog
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)({ hide: !(this.state.currentLog.localeCompare(SPARK_LOG) == 0) }) },
	          this.state.sparkLog
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)({ hide: !(this.state.currentLog.localeCompare(TRACING_LOG) == 0) }) },
	          this.state.cassandraTracingLog
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)({ hide: !(this.state.currentLog.localeCompare(SESSION_LOG) == 0) }) },
