...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewDApps = __webpack_require__(313);

	var _ViewDApps2 = _interopRequireDefault(_ViewDApps);

	var _EditDApps = __webpack_require__(316);

	var _EditDApps2 = _interopRequireDefault(_EditDApps);

	var _EditNodes = __webpack_require__(319);

	var _EditNodes2 = _interopRequireDefault(_EditNodes);

	var _ViewNodes = __webpack_require__(322);
	...
	$(function () {
	  ...
	  (0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: '/dapps' },
	      _react2.default.createElement(_reactRouter.Route, { path: 'view', component: _ViewDApps2.default }),
	      _react2.default.createElement(_reactRouter.Route, { path: 'edit', component: _EditDApps2.default })
	    ),
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: '/nodes' },
	      _react2.default.createElement(_reactRouter.Route, { path: 'edit', component: _EditNodes2.default }),
	      _react2.default.createElement(_reactRouter.Route, { path: 'view', component: _ViewNodes2.default })
	    ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.globals = exports.Navbar = undefined;
	...
	globals.web3 = new Web3(new Web3.providers.HttpProvider('http://' + globals.host + ':' + globals.port));
	...
	var Navbar = _react2.default.createClass({
	  ...
	  setContract: function setContract(event) {
	    ...
	    globals.contract.object = globals.contract.factory.at(event.target.value);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _makeStateWithLocation = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DApp = _react2.default.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    var contract = _globals.globals.contract;
	    var self = this;
	...
	var DAppActions = _react2.default.createClass({
	  ...
	  startup: function startup() {
	    ...
	    _globals.globals.contract.web3.object.startDApp(name, {
	  ...
	  fqu: function fqu() {
	    var name = $('input[name=dapp]:checked').val();
	    _globals.globals.contract.web3.object.finishDApp(name, {
	      from: Meteor.globals.coinbase,
	      gas: 100,
	      gasPrice: 1
	    }, function () {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditDApps = _react2.default.createClass({
	  ...
	  createNewDApp: function createNewDApp(argument) {
	    var ident = $("#ident").val();
	    var fee = $("#fee").val();
	    _globals.globals.contract.web3.object.createDApp(ident, parseInt(fee), {
	  ...
	  render: function render() {
	    var ident = _react2.default.createElement(
	      'label',
	      null,
	      _react2.default.createElement(
	        'span',
	    ...
	    var fee = _react2.default.createElement(
	      'label',
	      null,
	      _react2.default.createElement(
	        'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditNodes = _react2.default.createClass({
	  ...
	  createNewNode: function createNewNode(argument) {
	    ...
	    _globals.globals.contract.object.createNode(name, state, ipaddress, {
	      from: _globals.globals.coinbase,
	      gas: 100,
	      gasPrice: 1
	    }, function () {});
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Node = _react2.default.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    _globals.globals.contract.object.nodeList(this.props.index, function (err, name) {
	      _globals.globals.contract.object.nodes.call(name, function (err, info) {
	        self.setState({
	          ident: web3.toAscii(info[0]),
	...
	var NodeActions = _react2.default.createClass({
	  ...
	  payup: function payup() {
	    ...
	    _globals.globals.contract.object.nodes.call(name, function (err, info) {
	      _globals.globals.contract.object.sendTransaction({
	        from: _globals.globals.coinbase,
	        to: info[3],
	        value: 1
	      }, function () {});
